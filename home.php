...
<header class="home-header">
  <div class="home-header__bg"
    data-bg="<?php echo get_field('фоновая_картинка_на_первом_экране')['sizes']['2048x2048']; ?>">
  </div>
  <div class="container home-header__container a-center">
    ...
    <a data-href="#footer" data-i href="#"
      class="btn btn--white home-header__btn"><?php echo get_field('текст_кнопки_на_первом_экране'); ?>
...
<main>
  <section class='section services-section'>
    <div class='container section__container a-center'>
        ...
        <?php   
            ...
            if ( $my_query->have_posts() ) {
              while ( $my_query->have_posts() ) {
                ...
                $counter++;
          ?>
        <a data-show-items href="<?php the_permalink();?>"
          class="card services-section__card <?php if ($counter < 7) echo 'visible';?>">
          <div class="card__icon services-section__card-icon">
            <picture>
              <source
                srcset="<?php echo preg_replace('/\.+jpg|\.png/m', '.webp', get_field('иконка_для_главной_страницы')); ?>"
                type="image/webp">
      ...
      <button data-show-text="<?php echo translateRuUaEn('Больше услуг', 'Більше послуг', 'View more');?>"
        data-hide-text="<?php echo translateRuUaEn('Свернуть', 'Згорнути', 'Hide');?>" data-show-more
    ...
    <div class='container section__container polis-section__container last'>
      <div class="polis-section__container-left">
        ...
        <a href="<?php echo get_site_url()?>/<?php echo translateRuUaEn('polis','polis-ua','polis-en');?>"
          class="btn btn--black polis-section__btn">
      ...
      <div class="polis-section__container-right">
        <div class="polis-card">
          <div class="polis-card__content">
            <picture>
              <source
                srcset="<?php echo preg_replace('/\.+jpg|\.png/m', '.webp', get_field('изображение_на_передней_части_карты')); ?>"
                type="image/webp">
              <img class="polis-card__img polis-card__img--main"
                src="<?php echo get_field('изображение_на_передней_части_карты'); ?>" alt="card">
            </picture>
            <picture>
              <source
                srcset="<?php echo preg_replace('/\.+jpg|\.png/m', '.webp', get_field('изображение_на_задней_части_карты')); ?>"
                type="image/webp">
              <img class="polis-card__img polis-card__img--alternate"
                src="<?php echo get_field('изображение_на_задней_части_карты'); ?>" alt="card">
            </picture>
          </div>
        </div>
      </div>
