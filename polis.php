...
<header class="polis-header">
  <div class="polis-header__bg"
    data-bg="<?php echo get_field('фоновая_картинка_на_первом_экране'); ?>"></div>
      ...
      <ul class="how-work__items">
        ...
        <li class="how-work__item">
          <div class="how-work__icon">
            <img src="<?php echo $steps[$steps_numbers[$i].'_этап_иконка'];?>" alt="icon">
          </div>
          ...
          <div class="get-polis__item-left">
            <div class="polis-card">
              <div class="polis-card__content">
                ...
                <picture>
                  <source
                    srcset="<?php echo preg_replace('/\.+jpg|\.png/m', '.webp', $cards['изображение_на_передней_части_карты_'.$i]); ?>"
                    type="image/webp">
                    <img class="polis-card__img polis-card__img--main"
                  src="<?php echo $cards['изображение_на_передней_части_карты_'.$i] ?>" alt="card">
                </picture>
                <picture>
                  <source
                    srcset="<?php echo preg_replace('/\.+jpg|\.png/m', '.webp', $cards['изображение_на_задней_части_карты_'.$i]); ?>"
                    type="image/webp">
                    <img class="polis-card__img polis-card__img--alternate"
                  src="<?php echo $cards['изображение_на_задней_части_карты_'.$i] ?>" alt="card">
                </picture>
              </div>
            </div>
          </div>
